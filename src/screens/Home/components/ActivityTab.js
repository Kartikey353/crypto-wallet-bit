...
const ActivityTab = ({ transactions, account, currentNetwork }) => {
    return ( <
        div className = "" > {
            transactions ? .length > 0 ? (
                transactions.slice(0, 5).map((txn, i) => {
                    ...
                    return ( <
                        ...
                        <
                        div className = { `h-8 w-8 rounded-full border-2 border-primary flex justify-center items-center  text-lg text-primary ` } >
                        <
                      ...
                      isReceive ? "rotate-[230deg]" : "rotate-[45deg]"
                        ...
                        <
                        span className = "text-blue-400" > { dayjs(txn.block_signed_at).format("MM/DD/YYYY") } <
                        /span> <
                        span className = "inline-block ml-1" > { isReceive ? "From" : "To" }: { " " } { shortAddress(txn.from_address) } <
                        /span> <
                        /p> <
                        /div> <
                        /div> <
                        div >
                        <
                        p > { formatFromWei(txn.value) }
                        Matic < /p> <
                        p className = "text-[10px] text-right" > { formatFromWei(txn.value) }
                        Matic <
                        /p> <
                        /div> <
                        /a>
